...
UPDATE collectivity SET president_id = 'C1-M1', vice_president_id = 'C1-M2', secretary_id = 'C1-M3', treasurer_id = 'C1-M4' WHERE id = 'col-1';

-- ============================================================
-- MEMBRES COLLECTIVITÉ 2 (mêmes membres)
-- ============================================================
INSERT INTO collectivity_members (collectivity_id, member_id) VALUES
                                                                  ('col-2', 'C1-M1'), ('col-2', 'C1-M2'), ('col-2', 'C1-M3'), ('col-2', 'C1-M4'),
                                                                  ('col-2', 'C1-M5'), ('col-2', 'C1-M6'), ('col-2', 'C1-M7'), ('col-2', 'C1-M8');

UPDATE collectivity SET president_id = 'C1-M5', vice_president_id = 'C1-M6', secretary_id = 'C1-M7', treasurer_id = 'C1-M8' WHERE id = 'col-2';
...
UPDATE collectivity SET president_id = 'C3-M1', vice_president_id = 'C3-M2', secretary_id = 'C3-M3', treasurer_id = 'C3-M4' WHERE id = 'col-3';
...
INSERT INTO mobile_banking_account (id, holder_name, mobile_banking_service, mobile_number) VALUES ('C1-A-MOBILE-1', 'Mpanorina', 'ORANGE_MONEY', '0370489612');
INSERT INTO collectivity_financial_account (collectivity_id, financial_account_id) VALUES ('col-1', 'C1-A-CASH'), ('col-1', 'C1-A-MOBILE-1');

-- Collectivité 2
INSERT INTO financial_account (id, amount) VALUES ('C2-A-CASH', 0), ('C2-A-MOBILE-1', 0);
INSERT INTO cash_account (id) VALUES ('C2-A-CASH');
INSERT INTO mobile_banking_account (id, holder_name, mobile_banking_service, mobile_number) VALUES ('C2-A-MOBILE-1', 'Dobo voalohany', 'ORANGE_MONEY', '0320489612');
INSERT INTO collectivity_financial_account (collectivity_id, financial_account_id) VALUES ('col-2', 'C2-A-CASH'), ('col-2', 'C2-A-MOBILE-1');

-- Collectivité 3
INSERT INTO financial_account (id, amount) VALUES ('C3-A-CASH', 0);
INSERT INTO cash_account (id) VALUES ('C3-A-CASH');
INSERT INTO collectivity_financial_account (collectivity_id, financial_account_id) VALUES ('col-3', 'C3-A-CASH');

-- Nouveaux comptes collectivité 3
INSERT INTO financial_account (id, amount) VALUES ('C3-A-BANK-1', 0), ('C3-A-BANK-2', 0), ('C3-A-MOBILE-1', 0);
...
INSERT INTO mobile_banking_account (id, holder_name, mobile_banking_service, mobile_number) VALUES ('C3-A-MOBILE-1', 'Kolo', 'MVOLA', '0341889612');
INSERT INTO collectivity_financial_account (collectivity_id, financial_account_id) VALUES ('col-3', 'C3-A-BANK-1'), ('col-3', 'C3-A-BANK-2'), ('col-3', 'C3-A-MOBILE-1');
...
VALUES ('act-1', 'col-1', 'AG1', 'MEETING', 'JUNIOR,SENIOR,SECRETARY,TREASURER,VICE_PRESIDENT,PRESIDENT', 1, 'SA', NULL);

INSERT INTO activity (id, collectivity_id, label, activity_type, member_occupation_concerned, recurrence_week_ordinal, recurrence_day_of_week, executive_date)
VALUES ('act-2', 'col-1', 'Formation de base', 'TRAINING', 'JUNIOR', 2, 'SU', NULL);

-- COLLECTIVITÉ 2
INSERT INTO activity (id, collectivity_id, label, activity_type, member_occupation_concerned, recurrence_week_ordinal, recurrence_day_of_week, executive_date)
VALUES ('act-3', 'col-2', 'AG2', 'MEETING', 'JUNIOR,SENIOR,SECRETARY,TREASURER,VICE_PRESIDENT,PRESIDENT', 1, 'SU', NULL);

INSERT INTO activity (id, collectivity_id, label, activity_type, member_occupation_concerned, recurrence_week_ordinal, recurrence_day_of_week, executive_date)
VALUES ('act-4', 'col-2', 'Formation de base', 'TRAINING', 'JUNIOR', 3, 'SU', NULL);

INSERT INTO activity (id, collectivity_id, label, activity_type, member_occupation_concerned, recurrence_week_ordinal, recurrence_day_of_week, executive_date)
VALUES ('act-5', 'col-2', 'Perfectionnement', 'TRAINING', 'SENIOR', NULL, NULL, '2026-04-30');

-- COLLECTIVITÉ 3
INSERT INTO activity (id, collectivity_id, label, activity_type, member_occupation_concerned, recurrence_week_ordinal, recurrence_day_of_week, executive_date)
VALUES ('act-6', 'col-3', 'AG3', 'MEETING', 'JUNIOR,SENIOR,SECRETARY,TREASURER,VICE_PRESIDENT,PRESIDENT', 1, 'FR', NULL);

INSERT INTO activity (id, collectivity_id, label, activity_type, member_occupation_concerned, recurrence_week_ordinal, recurrence_day_of_week, executive_date)
VALUES ('act-7', 'col-3', 'Formation de base', 'TRAINING', 'JUNIOR', 4, 'WE', NULL);

-- ============================================================
-- PRÉSENCES AUX ACTIVITÉS (DONNÉES BONUS)
-- ============================================================

-- ATTENTION: Pour les activités récurrentes, on ne garde qu'une seule occurrence (la plus récente)
-- car la contrainte UNIQUE (activity_id, member_id) l'exige.

DELETE FROM member_attendance WHERE activity_id IN ('act-1', 'act-3', 'act-5', 'act-6');

-- COLLECTIVITÉ 1 - AG1 (Tableau 25 - Avril 2026)
INSERT INTO member_attendance (activity_id, member_id, attendance_status) VALUES
                                                                              ('act-1', 'C1-M1', 'ATTENDED'), ('act-1', 'C1-M2', 'ATTENDED'),
                                                                              ('act-1', 'C1-M3', 'MISSING'), ('act-1', 'C1-M4', 'MISSING'),
                                                                              ('act-1', 'C1-M5', 'ATTENDED'), ('act-1', 'C1-M6', 'ATTENDED'),
                                                                              ('act-1', 'C1-M7', 'ATTENDED'), ('act-1', 'C1-M8', 'ATTENDED');

-- COLLECTIVITÉ 2 - AG2 (Tableau 27 - Avril 2026)
INSERT INTO member_attendance (activity_id, member_id, attendance_status) VALUES
                                                                              ('act-3', 'C1-M1', 'ATTENDED'), ('act-3', 'C1-M2', 'ATTENDED'),
                                                                              ('act-3', 'C1-M3', 'MISSING'), ('act-3', 'C1-M4', 'ATTENDED'),
                                                                              ('act-3', 'C1-M5', 'ATTENDED'), ('act-3', 'C1-M6', 'ATTENDED'),
                                                                              ('act-3', 'C1-M7', 'ATTENDED'), ('act-3', 'C1-M8', 'MISSING');

-- COLLECTIVITÉ 2 - Perfectionnement (Tableau 28)
INSERT INTO member_attendance (activity_id, member_id, attendance_status) VALUES
                                                                              ('act-5', 'C1-M1', 'ATTENDED'), ('act-5', 'C1-M2', 'ATTENDED'),
                                                                              ('act-5', 'C1-M3', 'ATTENDED'), ('act-5', 'C1-M4', 'MISSING');

-- COLLECTIVITÉ 3 - AG3 (Tableau 30 - Avril 2026)
INSERT INTO member_attendance (activity_id, member_id, attendance_status) VALUES
                                                                              ('act-6', 'C3-M1', 'ATTENDED'), ('act-6', 'C3-M2', 'ATTENDED'),
                                                                              ('act-6', 'C3-M3', 'MISSING'), ('act-6', 'C3-M4', 'MISSING'),
                                                                              ('act-6', 'C3-M5', 'ATTENDED'), ('act-6', 'C3-M6', 'ATTENDED'),
                                                                              ('act-6', 'C3-M7', 'MISSING'), ('act-6', 'C3-M8', 'ATTENDED'),
